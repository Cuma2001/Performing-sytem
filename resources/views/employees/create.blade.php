...
@section('page-subtitle', 'Create a new employee')
        ...
        <form method="POST" action="{{ route('employees.store') }}">
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="employee_code" id="employee_code" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" required value="{{ old('employee_code') }}">
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="first_name" id="first_name" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" required value="{{ old('first_name') }}">
                ...
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="last_name" id="last_name" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" required value="{{ old('last_name') }}">
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="mobile" id="mobile" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('mobile') }}">
                </div>
                <div class="col-md-6" style="margin-bottom: 16px;">
                    <label for="position" style="display: block; font-weight: 600; margin-bottom: 4px;">Position <span style="color: red;">*</span></label>
                    <input type="text" name="position" id="position" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" required value="{{ old('position') }}">
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="department" id="department" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('department') }}">
                </div>
                <div class="col-md-6" style="margin-bottom: 16px;">
                    <label for="designation" style="display: block; font-weight: 600; margin-bottom: 4px;">Designation</label>
                    <input type="text" name="designation" id="designation" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('designation') }}">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="number" name="base_salary" id="base_salary" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('base_salary') }}" step="0.01">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 16px;">
                    ...
                    <input type="number" name="commission_rate" id="commission_rate" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('commission_rate') }}" step="0.01" min="0" max="100">
                </div>
                <div class="col-md-6" style="margin-bottom: 16px;">
                    <label for="bonus_rate" style="display: block; font-weight: 600; margin-bottom: 4px;">Bonus Rate (%)</label>
                    <input type="number" name="bonus_rate" id="bonus_rate" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" value="{{ old('bonus_rate') }}" step="0.01" min="0" max="100">
                </div>
            </div>
            ...
            <div style="margin-bottom: 16px;">
                ...
                <textarea name="notes" id="notes" class="form-control" style="width: 100%; padding: 10px 14px; border: 1px solid #e2e8f0; border-radius: 8px;" rows="3">{{ old('notes') }}</textarea>
            </div>
